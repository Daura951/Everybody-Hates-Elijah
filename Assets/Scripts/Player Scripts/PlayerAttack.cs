...
public class PlayerAttack : MonoBehaviour
{
    ...
    void Attack()
    {
        ...
        //Jab if statement
        if ((Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Fire2")) && Input.GetAxisRaw("Vertical") == 0 && !isAttacking && anim.GetBool("Idle") == true && !playerMovement.isInAir)
        {
            print("Jab");
            isSpecial = false;
            isAttacking = true;
        ...
        else if ((Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Fire2")) && !isAttacking && Input.GetAxisRaw("Vertical") > 0 && anim.GetBool("Idle") && !playerMovement.isInAir)
        {
            print("UTilt");
            isAttacking = true;
        }

        else if ((Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Fire2")) && !isAttacking && Input.GetAxisRaw("Vertical") < 0 && anim.GetBool("Crouch") && !playerMovement.isInAir)
        {
            print("DTilt");
            isAttacking = true;
        }

        else if ((Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Fire2")) && !isAttacking && Input.GetAxisRaw("Horizontal") != 0 && !playerMovement.isInAir)
        {
            print("FTilt");
            isAttacking = true;
        }

        else if ((Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Fire2")) && !isAttacking && Input.GetAxisRaw("Vertical") == 0 && Input.GetAxisRaw("Horizontal") == 0 && playerMovement.isInAir)
        {
            isAttacking = true;
            print("Nair");
        }

        else if ((Input.GetKeyDown(KeyCode.P) || Input.GetButtonDown("Fire2")) && !isAttacking && Input.GetAxisRaw("Vertical") > 0 && playerMovement.isInAir)
        {
            print("Uair");
            isAttacking = true;
        }
        ...
        else if ((Input.GetKeyDown(KeyCode.O) || Input.GetButtonDown("Fire1")) && !isAttacking && anim.GetBool("Idle") == true && !playerMovement.isInAir && Input.GetAxisRaw("Vertical") == 0f && Input.GetAxisRaw("Horizontal") == 0f)
        {
            print("NSpecial");
            isSpecial = true;
            isAttacking = true;
        ...
        else if ((Input.GetKeyDown(KeyCode.O) || Input.GetButtonDown("Fire1")) && !isAttacking && Input.GetAxisRaw("Vertical") < 0f && !playerMovement.isInAir)
        {
            isAttacking = true;
            isSpecial = true;
            print("DSpecial");
        ...
        else if ((Input.GetKeyDown(KeyCode.O) || Input.GetButtonDown("Fire1")) && !isAttacking && Input.GetAxisRaw("Horizontal") != 0f && Input.GetAxisRaw("Vertical") == 0 && !playerMovement.isInAir)
        {
            isAttacking = true;
            isSpecial = true;
            print("FSpecial");
        ...
        else if ((Input.GetKey(KeyCode.I) || Input.GetButtonDown("Fire3")) && !strongDone && Input.GetAxisRaw("Vertical")==0 && !playerMovement.isInAir)
        {
            isAttacking = true;
            if (!strongStarted)
            {
        ...
        else if ((Input.GetKeyUp(KeyCode.I) || Input.GetButtonUp("Fire3")) || strongDone)
        {
