...
public class AS_KickState : MeleeAttackState
{
    private AngryStudent angryStudent;
    public AS_KickState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, Transform attackPosition, D_MeleeAttack stateData, AngryStudent angryStudent) : base(entity, stateMachine, animBoolName, attackPosition, stateData)
    {
